...
1. Open one of these. Both start a temporary Linux machine on their servers and show you a terminal directly on the web page that talks to it. Type your commands there. The machine is deleted shortly after you close the tab.
